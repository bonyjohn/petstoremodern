...
/** The shipping quantity decision as a pure function, kept separate so it's trivially testable. */
public final class ShippingMath {
	...
	/**
	 * How many units to ship for one line: the unshipped remainder, capped by
	 * what's on hand, never negative.
	 */
